/*Solve the following questions in your VSCode and share your GitHub link (40Marks)
...
/*Write a function that takes an array of objects,
 where each object represents a product with a name, price,
  and category property. The function should return an object that
   groups the products by their categories, with the category names as
    keys and the arrays of products as values. const products = [
...
const products = [
  ...
  const categoryName = Object.groupBy(products, ({category}) => {
    return category;
  });
